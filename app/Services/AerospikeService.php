...
class AerospikeService implements AerospikeClient
{
    ...
    public function putFloat(string $namespace, $set, int|string $id, float $value, int | null $version = null): bool
    {
    ...
    public function delete(string $namespace, $set, string | int $id, int | null $version = null, string | null $filterExp = null): bool {
